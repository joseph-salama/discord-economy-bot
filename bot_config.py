...
MATCH_ACCEPTED_TIMEOUT_SECONDS = 7200  # 2 hours — ACCEPTED battles auto-cancel + refund
MATCH_ACTIVE_TIMEOUT_SECONDS = 7200  # 2 hours — ACTIVE battles (incl. dual-report waits) auto-cancel + refund
TEAM_MATCH_OPEN_TIMEOUT_SECONDS = 7200  # 2 hours — OPEN team matches auto-cancel + refund
TEAM_MATCH_ACTIVE_TIMEOUT_SECONDS = 7200  # 2 hours — ACTIVE team matches auto-cancel + refund
